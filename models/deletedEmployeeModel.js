...
const deletedEmployeeSchema = new mongoose.Schema({
  ...
  // Additional fields for tracking deletion
  deletedAt: { type: Date, default: Date.now },
  deletedBy: { type: String, default: "" }, // Employee ID of who deleted
  deletionReason: { type: String, default: "" },
  canRestore: { type: Boolean, default: true }
}, {
  timestamps: true,
  collection: "Deleted employees" // Explicitly set collection name
});
